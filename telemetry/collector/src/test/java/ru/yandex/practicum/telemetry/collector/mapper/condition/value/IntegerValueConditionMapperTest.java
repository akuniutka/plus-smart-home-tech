...
class IntegerValueConditionMapperTest {
    ...
    void setUp() {
        ...
        mapper = new IntegerValueConditionMapper(mockConditionTypeMapper, mockOperationMapper);
    }
    ...
    @Test
    void whenGetValueType_ThenReturnIntValue() {
        final ScenarioConditionProto.ValueCase valueType = mapper.getValueType();

        assertThat(valueType, equalTo(ScenarioConditionProto.ValueCase.INT_VALUE));
    }
